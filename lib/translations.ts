...
export const loginTranslations = {
  en: {
    ...
    verifyPendingBody: 'Verification email sent to {email}. Please check and click the link to verify.',
    verifyPendingHint: 'It may take a few minutes.',
    ...
    verificationConfirmed: 'Email verified. Continue your profile to start matching.',
    checkVerified: 'I have verified',
    backToSignIn: 'Back to sign in',
    unverifiedRedirect: 'Please verify your email first.',
    verifiedSignInHint: 'Email verified. Please sign in to continue your profile.',
  },
  zh: {
    toggleLang: 'EN',
    emailLabel: '邮箱',
    ...
    verifyPendingTitle: '验证邮件已发送',
    verifyPendingBody: '验证邮件已发送至 {email}，请查收并点击链接完成验证。',
    verifyPendingHint: '这大概需要几分钟。',
    resendCountdown: '{seconds}s 后可重新发送',
    resend: '重新发送邮件',
    resendSuccess: '验证邮件已重新发送。',
    resendError: '重新发送失败，请稍后重试。',
    verificationConfirmed: '邮箱已验证，继续完善资料即可开启匹配之旅。',
    checkVerified: '我已完成验证',
    backToSignIn: '返回登录',
    unverifiedRedirect: '请先完成邮箱验证。',
    verifiedSignInHint: '邮箱已验证，请重新登录后继续完善资料。',
  },
} as const;
