...
export const registrationTranslations: Record<Language, RegistrationText> = {
  zh: {
    ...
    termsAnd: '和',
    sections: [
      { title: '创建账户', description: '只需30秒，开启你的慢揭晓之旅。' },
      { title: '基础档案', description: '这一部分帮助我们构建你的基本画像，也是生成线索的底色。' },
      { title: '生活与感官', description: '这些微小而确定的习惯，是你感知世界的方式。' },
      { title: '情感模式与期待', description: '我们对待亲密关系的方式，往往藏在一些瞬间的选择里。' },
    ...
    errors: {
      ...
      password_missing_letter: '密码需包含至少一个字母',
      password_missing_number: '密码需包含至少一个数字',
      confirm_password_mismatch: '两次输入的密码不一致',
      auth_session_missing: '注册会话未建立，请稍后重试',
      past_date: '生日必须是过去日期',
    ...
    options: {
      ...
      scent_memory: {
        home_cooking: '妈妈煮的饭菜香/爸爸的剃须水',
        rain_grass: '雨后泥土和青草的腥味',
        old_books: '老书/木质家具的味道',
        pool_sea: '泳池的漂白水味/海风的咸味',
        perfume: '某种香水/洗衣液的留香',
        not_sensitive: '说不清，但我对气味很敏感，是判断好感的第一道门槛',
        custom: '其他（自定义）',
      },
      ritual: {
        wipe_cup: '喝前先擦杯沿',
      ...
      conflict_reaction: {
        ...
        talk_immediately: '想立刻说清楚，甚至希望对方能抱抱我',
        pretend_fine: '表面上说没事，但心里希望对方能主动来找我',
        depends: '视情况而定，有时候想冷静，有时候想立刻解决',
      },
      recharge_style: {
        deep_talk: '和伴侣深度倾诉，把情绪说出来',
        alone_time: '独自看电影、打游戏或读书，不被打扰',
        quality_time: '和伴侣一起出门吃饭、逛街、做些轻松的事',
        friends_social: '找朋友一起嗨，把烦恼抛在脑后',
      },
      valued_traits: {
        humor: '幽默',
        gentle: '温柔',
  ...
  en: {
    ...
    termsAnd: 'and',
    sections: [
      { title: 'Create Account', description: 'In just 30 seconds, start your slow-reveal journey.' },
      { title: 'Profile & Identity', description: 'This section helps us build your basic profile-the foundation for generating clues.' },
      { title: 'Life & Senses', description: 'These small and certain habits are how you perceive the world.' },
      { title: 'Emotional Pattern & Expectations', description: 'How we approach intimacy is often revealed in split-second choices.' },
    ...
    placeholders: {
      ...
      password: 'At least 8 characters, letters & numbers',
      confirm_password: 'Confirm password',
    ...
    errors: {
      ...
      auth_session_missing: 'Auth session is not ready. Please try again.',
    ...
    options: {
      ...
      color_mood: {
        warm_gold: 'Warm gold/orange (hopeful, positive)',
        calm_blue: 'Calm blue/green (peaceful, introspective)',
        chaotic_gray: 'Chaotic gray/black (tired, need to recharge)',
        mysterious_purple: 'Mysterious purple (imaginative, curious about the unknown)',
        custom: 'Other (custom)',
      },
      scent_memory: {
        home_cooking: "Mom's cooking / Dad's aftershave",
        rain_grass: 'The earthy smell of wet soil and grass after rain',
        old_books: 'The scent of old books / wooden furniture',
        pool_sea: 'Pool chlorine / salty sea breeze',
        perfume: 'A lingering perfume / laundry detergent scent',
        not_sensitive: "Hard to describe, but I'm very sensitive to scent; it's my first filter for attraction",
        custom: 'Other (custom)',
      },
      ritual: {
      ...
      conflict_reaction: {
        need_space: 'Need some space to calm down, then communicate after thinking it through',
        talk_immediately: 'Want to talk things through immediately, and even hope for a hug',
        pretend_fine: "Say I'm fine on the surface, but hope the other person reaches out first",
        depends: 'Depends on the situation; sometimes I need space, sometimes I want to solve it right away',
      },
      recharge_style: {
        deep_talk: 'Have a deep talk with my partner and speak my emotions out loud',
        alone_time: 'Watch movies, play games, or read alone without being disturbed',
        quality_time: 'Go out with my partner for food, a walk, or something light and easy',
        friends_social: 'Go have fun with friends and leave worries behind',
      },
      valued_traits: {
        humor: 'Humor',
        gentle: 'Gentle',
